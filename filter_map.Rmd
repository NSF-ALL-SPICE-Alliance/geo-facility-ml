...
filtered_data <- reactive({
  ...
  # Print selected category and service
  cat("Selected Category:", input$overall_category, "\n")
  cat("Selected Service:", input$service, "\n")
  
  # Split the service_code_info into individual services
  services <- strsplit(geocoded_facilities_filtered$service_code_info, " \\* ")
  
  # Print the split services
  cat("Split Services:")
  #print(services)
  
  # Check if any service contains the selected category and service
  filtered <- geocoded_facilities_filtered[sapply(services, function(x) {
    any(grepl(input$overall_category, x)) && any(grepl(input$service, x))
  }), ]
