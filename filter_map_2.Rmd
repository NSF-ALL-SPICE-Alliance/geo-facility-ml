...
geocoded_facilities_filtered$service_code_info <- sapply(
  strsplit(geocoded_facilities_filtered$service_code_info, " \\* "), 
  replace_abbrev_with_full, 
  full_definitions
)
geocoded_facilities_filtered$service_code_info <- sapply(
  geocoded_facilities_filtered$service_code_info, 
  paste, 
  collapse = " * "
)
```
...
server <- function(input, output, session) {
  ...
  filtered_data <- reactive({
    ...
    print(paste("Selected Service:", input$service))
    print(services)
